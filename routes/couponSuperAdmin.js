 ...
 *   description: Coupon management for super admin (all companies)
 */

/**
 * @swagger
 * /api/v1/super-admin/coupon:
 *   get:
 *     summary: Get ALL coupons across all companies
 *     tags: [Super Admin Coupons]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: List of all coupons with isActive status
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *   post:
 *     summary: Create new coupon for any company
 *     tags: [Super Admin Coupons]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *         description: Forbidden - Not super admin
 *   patch:
 *     summary: Update coupon (any company)
 *     tags: [Super Admin Coupons]
 *     security:
 *       - bearerAuth: []
 *     parameters:
